# Django settings for dumponus project.
import os
...
SECRET_KEY = '4m+*fgir8-fr**7z3$sf5uw(k+4f6wu1f^ve*ob=a+*t8wbw9)'
...
ROOT_URLCONF = 'dumponus.urls'

WSGI_APPLICATION = 'dumponus.wsgi.application'
